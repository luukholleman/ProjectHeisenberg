...
from api.meeting.views import MeetingViewSet, MeetingAgendaApiView, MeetingMinutesApiView, MeetingAttachmentsApiView
...
urlpatterns = [
    ...
    url(r'^meetings/(?P<meetingId>\d+)/attachments', MeetingAttachmentsApiView.as_view(), name='meeting-attachments'),
